...
uread(int uart, unsigned int reg)
{
  ...
  if(uart == 0)
    {
      val = *(volatile unsigned char*)(0xffeffb08 + reg);
    }
  else
    {
      val = *(volatile unsigned char*)(0xffeffb00 + reg);
    }
...
uwrite(int uart, int reg, unsigned int val)
{
  ...
  if(uart == 0)
    {
      *(volatile unsigned char*)(0xffeffb08 + reg) = (unsigned char)val;
    } 
  else
    {
      *(volatile unsigned char*)(0xffeffb00 + reg) = (unsigned char)val;
    }
}
